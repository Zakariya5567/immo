...
import 'components/onboard_Custom_design.dart';
            ...
            builder: (context, language, child) {
              return Container(
                ...
                child: Column(
                  children: [
                    OnBoardCustomDesign(
                      image1: Images.onBoardImage5,
                      image2: Images.onBoardImage6,
                      yellowBackGroundImage: Images.yellowBack2,
                      yellowBackgroundText:
                          translate(context, language.languageCode, soldText)!,
                      shapeColor: whitePrimary,
                      headerText: translate(
                          context, language.languageCode, sellYourHouseText)!,
                      bodyText: translate(context, language.languageCode,
                          onBoardDescriptionText)!,
                      sliderIcon: Images.onBoardSliderIcon3,
                    ),
                    Padding(
                        ...
                        children: [
                          ...
                          OnBoardCustomButton(
                              buttonName: translate(
                                  context, language.languageCode, logIn)!,
                              iconName: "",
                              onPressed: () {
                                Navigator.of(context).pushReplacementNamed(
                                    RouterHelper.emailSignInScreen);
