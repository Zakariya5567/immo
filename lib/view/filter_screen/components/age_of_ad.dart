...
class AgeOfAdSelection extends StatelessWidget {
  const AgeOfAdSelection(
      {Key? key, required this.list, required this.controller})
      : super(key: key);
  final List<AgeOfAdData> list;
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(translate(context, language.languageCode, ageOfAd)!,
                      style: textStyle(
                          fontSize: 16,
                          color: blackLight,
                          ...
                          return Padding(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                color: controller.ageOfAdIndex == position
                                    ? blueShadow
                                    : greyShadow,
                              ...
                              controller.setAgeOfAdIndex(position, context);
                            }),
                          );
                        },
                      ),
